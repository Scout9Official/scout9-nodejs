...
import type { GetApiFunction, Customer, PostApiFunction, PutApiFunction, DeleteApiFunction } from '@scout9/app';
 ...
 */
export const GET: GetApiFunction<{customer: string}> = async ({params}) => {
 ...
 */
export const POST: PostApiFunction<{customer: string}, Customer> = async ({params, body: newCustomer}) => {
 ...
 * @returns {Promise<import('@scout9/app').EventResponse>}
 */
export const PUT: PutApiFunction<{customer: string}, Customer> = async ({params, body: updatedCustomer}) => {
  await customerDb.update(params.customer, updatedCustomer);
 ...
 * @returns {Promise<import('@scout9/app').EventResponse>}
 */
export const DELETE: DeleteApiFunction<{customer: string}> = async ({params}) => {
