...
export default class Scout9CRM {
   ...
   */
  public add(customerOrCustomers: Customer | Customer[]): Promise<CreateCustomerResponse | CreateCustomersResponse>;
   ...
   */
  public update(updateOrUpdates: Partial<Customer> & {$id: string;} | Array<Partial<Customer> & {$id: string;}>): Promise<UpdateCustomerResponse | UpdateCustomersResponse>;
   ...
   */
  public remove(idOrIds: string | string[]): Promise<DeleteCustomerResponse | DeleteCustomersResponse>;
